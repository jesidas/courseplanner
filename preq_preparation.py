...
vocab_dic = {}
i = 0
with open('../datasets/NPTEL MOOC Dataset/vocab.txt', 'r') as f:
	for w in f:
...
concept_vocab = {}
of = open('../datasets/NPTEL MOOC Dataset/cs_preqs_index.txt', 'w')
map_dict = {}
with open('../datasets/NPTEL MOOC Dataset/cs_preq.csv', 'r') as f:
...
with open('../datasets/NPTEL MOOC Dataset/concept_vocab.pkl', 'wb') as fid:
